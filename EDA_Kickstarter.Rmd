...
funding goals. As we can see, the mode occurs somewhere in our 0-5% bucket and the
...
Of these 4,000 live projects, how long will they be available on Kickstarter? It
looks like at this given time, projects end within the next month (this data was
pulled on Oct. 29th). I wonder if the approaching holiday season had any influence
here...
...
I was wondering how much funding these projects typically get, it looks like if you
only need $1,000 to get your idea started, Kickstarter might be an appropriate
platform.
...
In plot 3, I wanted to show the relationship between well funded projects and 
the duration (in weeks) remaining until their end time. What we found is not so
shocking, that as you increase funding percentage and total amount pledged, you
generally approached projects with fewer weeks until their end times.
...
* Find any correlation between our variables and meeting funding goals
